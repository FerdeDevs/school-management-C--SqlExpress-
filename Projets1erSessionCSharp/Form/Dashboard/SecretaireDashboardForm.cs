...
{
    public partial class SecretaireDashboardForm : Form
    {
        ...
        public SecretaireDashboardForm()
        {
            InitializeComponent();
        }
        ...
        private void SecretaireDashboardForm_Load(object sender, EventArgs e)
        {
            searchData();
        }
        ...
        private void DataGridView_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.ColumnIndex == 8 && e.RowIndex > -1)
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    //4. Requete
                    string query = "DELETE FROM secretaire WHERE code = @code";
