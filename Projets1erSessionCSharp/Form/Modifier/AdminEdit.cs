...
namespace Projets1erSessionCSharp.user.userEdit
{
    public partial class AdminEdit : Form
    {
        ...
        public AdminEdit(string NewId, int Nver)
        {
            InitializeComponent();
            ID = NewId;
            verification = Nver;
        ...
        public void searchData()
        {
            try
            {
                ...
                //4. Requete
                string query = "SELECT * FROM admin WHERE code = '" + ID + "' ORDER BY code DESC";
        ...
        private void btnCreate_Click(object sender, EventArgs e)
        {
            ...
            //4. Requete
            string query = "UPDATE admin set nom = @nom, prenom = @prenom, email = @email, adresse =@adresse, telephone = @telephone, sexe = @sexe WHERE code = @code";
        ...
        public void pictureUpdated()
        {
            ...
            string query = "UPDATE admin set photos = @photos WHERE code = @code";
        ...
        private void btnMdpUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (mdp == rmdp)
            {
                ...
                else
                {
                    ...
                    //4. Requete
                    string query = "UPDATE admin set mdp = @mdp WHERE code = @code";
