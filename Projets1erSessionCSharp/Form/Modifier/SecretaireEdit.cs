...
{
    public partial class SecretaireEdit : Form
    {
        ...
        public SecretaireEdit(string NewId, int Nver)
        {
            InitializeComponent();
            ID = NewId;
            verification = Nver;
        ...
        public void searchData()
        {
            try
            {
                ...
                //4. Requete
                string query = "SELECT * FROM secretaire WHERE code = '" + ID + "' ORDER BY code DESC";
        ...
        private void SecretaireEdit_Load(object sender, EventArgs e)
        {
               panelMdp.Hide();
            if (verification == 1)
            {
        ...
        private void btnCreate_Click(object sender, EventArgs e)
        {
            ...
            //4. Requete
            string query = "UPDATE secretaire set nom = @nom, prenom = @prenom, email = @email, adresse =@adresse, telephone = @telephone, sexe = @sexe WHERE code = @code";
        ...
        public void pictureUpdated()
        {
            ...
            string query = "UPDATE secretaire set photos = @photos WHERE code = @code";
        ...
        private void btnMdpUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (mdp == rmdp)
            {
                ...
                else
                {
                    ...
                    //4. Requete
                    string query = "UPDATE secretaire set mdp = @mdp WHERE code = @code";
